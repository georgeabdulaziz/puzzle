...
function Piece(x, y, heads, linked, piecePos, id, others){
        ...
        for(var i = 0 ; i< number; i++){
            ...
            if((THIS.pos.x + THIS.r < other.pos.x )&& (THIS.pos.x + THIS.r > (other.pos.x - this.eatDistance))&& ((THIS.pos.y+THIS.r/2) > (other.pos.y)) && ((THIS.pos.y+THIS.r/2) < (other.pos.y + other.r))){ //this on the left
                ...
                if(THIS.heads[0] == 1 && other.heads[2] == 0 && !other.defence){ //this wins
                    ...
                    var linkedPiece = new Piece(THIS.pos.x + THIS.r, THIS.pos.y, LHeads, LLinked, LpiecePos, Lid, THIS.others); //console.log(linkedPiece);
                    ...
                    if(other.imlinked){
                            ...
                            if(others[g].id == other.motherId){
                                ...
                                for(var k = others[g].linked.length-1; k >= 0; k--){
                                  if(!linkedRange.includes(others[g].linked[k].piecePos)){
                                    ...
                                    var linkedPieceRemoved = new Piece(linkedPiece.pos.x +(others[g].linked[k].pos.x -other.pos.x), linkedPiece.pos.y+(others[g].linked[k].pos.y - other.pos.y ), LHeads, LLinked, LpiecePos, Lid, this.others); //console.log(linkedPiece);
                        ...
                        if(other.linked.length>0){
                            for(var k = 0 ; k < other.linked.length; k++){
                                ...
                                var linkedPieceRemoved = new Piece(linkedPiece.pos.x +(other.linked[k].pos.x -other.pos.x), linkedPiece.pos.y+(other.linked[k].pos.y - other.pos.y ), LHeads, LLinked, LpiecePos, Lid, this.others); //console.log(linkedPiece);
                ...
                if(THIS.heads[3] == 1 && other.heads[1] == 0 && !other.defence){ //this wins
                    ...
                    var linkedPiece = new Piece(THIS.pos.x, THIS.pos.y + THIS.r, LHeads, LLinked, LpiecePos, Lid, THIS.others); //console.log(linkedPiece);
                    THIS.heads[3] = 2;
