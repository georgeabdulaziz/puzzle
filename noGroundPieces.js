...
//import{borderThink, groundHeight, groundWidth, totalHeight, totalWidth} from './index.js';
    ...
    this.eats = function(other){
        ...
        for(var i = 0 ; i< number; i++){
            ...
            if((THIS.pos.x + THIS.r < other.pos.x )&& (THIS.pos.x + THIS.r > (other.pos.x - this.eatDistance))&& ((THIS.pos.y+THIS.r/2) > (other.pos.y)) && ((THIS.pos.y+THIS.r/2) < (other.pos.y + other.r))){ //this on the left
                //if((this.pos.x + this.r < other.pos.x )&& (this.pos.x + this.r > (other.pos.x - this.eatDistance)) && ((this.pos.y+this.r/2) > (other.pos.y)) && ((this.pos.y+this.r/2) < (other.pos.y + other.r))){ //this on the left    
                //console.log(this);
                if(THIS.pieceHeads[0] == 1 && other.pieceHeads[2] == 0 && this.win){ //this wins
                    this.win = false;
                    //console.log('eating on the left');
                    var LQuarters = other.pieceQuarters; //console.log('LQuarters '+LQuarters );
                    var LHeads = other.pieceHeads; LHeads[2] = 2; LHeads[0] = parseInt(random(2)); //console.log('LHeads '+LHeads );//removing the head or slot;
                    ...
                    if(other.imlinked){
                        ...
                        if(other.linked.length>0){
                            for(var k = 0 ; k < other.linked.length; k++){
                                ...
                                var LHeads = other.linked[k].pieceHeads;
                ...
                //else if((this.pos.x > (other.pos.x + other.r)) && (this.pos.x < (other.pos.x + other.r + this.eatDistance)) && ((this.pos.y+this.r/2) > (other.pos.y)) && ((this.pos.y+this.r/2) < (other.pos.y + other.r))){ //this on the right
                if(THIS.pieceHeads[2] == 1 && other.pieceHeads[0] == 0 && this.win){ //this wins
                    this.win = false;
                    var LQuarters = other.pieceQuarters; //console.log('LQuarters '+LQuarters );
                    var LHeads = other.pieceHeads; LHeads[0] = 2; LHeads[2] = parseInt(random(2));//console.log('LHeads '+LHeads );//removing the head or slot;
                    var LLinked = other.linked;
                    var Lid = other.id;
                    //var LLinkedQuarters = other.linkedQuarters; //this is on the left
                    var LpiecePos = [THIS.piecePos[0]-1 , THIS.piecePos[1]];
                ...
                if(THIS.pieceHeads[3] == 1 && other.pieceHeads[1] == 0 && this.win){ //this wins
                    this.win = false;
                    var LQuarters = other.pieceQuarters; //console.log('LQuarters '+LQuarters );
                    var LHeads = other.pieceHeads; LHeads[1] = 2; LHeads[3] = parseInt(random(2));//console.log('LHeads '+LHeads );//removing the head or slot;
                    var LLinked = other.linked;
                    var Lid = other.id;
                    //var LLinkedQuarters = other.linkedQuarters; //this is on the left
                ...
                //else if((this.pos.y > (other.pos.y + other.r)) && (this.pos.y < (other.pos.y + other.r + this.eatDistance)) && ((this.pos.x+this.r/2) > (other.pos.x)) && ((this.pos.x+this.r/2) < (other.pos.x + other.r))){ //this on the bottom
                if(THIS.pieceHeads[1] == 1 && other.pieceHeads[3] == 0 && this.win){ //this wins
                    this.win = false;
                    var LQuarters = other.pieceQuarters; //console.log('LQuarters '+LQuarters );
                    var LHeads = other.pieceHeads; LHeads[3] = 2; LHeads[1] = parseInt(random(2));//console.log('LHeads '+LHeads );//removing the head or slot;
                    var LLinked = other.linked;
                    var Lid = other.id;
